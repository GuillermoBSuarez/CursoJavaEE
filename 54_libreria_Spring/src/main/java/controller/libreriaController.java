...
public class libreriaController {
	...
	public String buscarCliente(String usuario, String password, Model model) {
	...
	public @ResponseBody List<Libro> quitar(@RequestParam("pos") int pos, HttpSession sesion) {
		List<Libro> carrito = new ArrayList<>(); 
		if (sesion.getAttribute("carrito") != null) {
			carrito = (List<Libro>) sesion.getAttribute("carrito");
			carrito.remove(pos);
